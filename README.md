# 🎯 Project Objective
To design and implement a microprocessor-based system using the Intel 8086 and 8255 PPI to interface input (push buttons) and output (7-segment display) devices. The system dynamically switches between real-time data mapping and a "freeze" state using software logic.
